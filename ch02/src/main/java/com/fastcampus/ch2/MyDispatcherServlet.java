...
public class MyDispatcherServlet extends HttpServlet { //서블릿은 HttpServlet을 상속받아야한다
	@Override
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
		//서블릿은 service를 반드시 만들어야하고 매개변수로 HttpServletRequest와 HttpServletResponse를 사용한다. 고정이다
